...
<body>
	...
	<div class="contenedor">
		...
		<div id="CuadroHistorial" style="display: none">
			...
			<br><br>
			<a href="pdf_historial_pago.php?codigo_inmueble=<?php echo $codigo_inmueble?>&nombre_inquilino=<?php echo $dato_inquilino['nombre_inquilino'] ?>&fecha_inicio=<?php echo $fecha; ?>&fecha_final=<?php echo $nuevafecha; ?>&cuota_renta=<?php echo $cuota_renta ?>&cuota=<?php echo $cuota ?>&tiempo_alquiler=<?php echo $dato['tiempo_alquiler'] ?>&mostrar_contrato=Si&codigo_factura=<?php echo $codfac ?>" class="BotonImprimir boton_historial">Imprimir historial</a>
		</div>
		...
		<br><br>
			...
			<?php if ($atras=='HistorialContratos') { ?>
				...
				<a href="historial_contratos.php" class="BotonRegresar">Atrás</a>
			<?php } ?>
