...
?>
	...
	<div class="contenedor_archivo">
	  	<div class="divInsertar">
			...
			?>
	  		<a href="pdf_inmuebles_disponibles.php?codigo_inmueble=<?php echo $dato['codigo_inmueble']?> " <?php echo $disabled; ?> title="<?php echo $titulo; ?>"><img src="../IMAGEN/print-printer-tool-with-printed-paper-outlined-symbol_icon-icons.png"></a>
	  	</div>
					   ...
					   exit();
						...
						<div id="codigo_cc">
							...
							<?php
				  			...
				  			echo "</select>";
				  			?>
							<input type="number" name="pisos_cc" maxlength="20" placeholder="Piso" />
						</div>
					<?php }
				?>
				
				<div class="DivPrecio">
					<input type="number" name="precio_inmueble" required placeholder="Precio del alquiler" />
					<select required name="moneda_precio_inmueble">
		...
		<form class="form_buscar" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
	  		<span>Inmuebles Disponibles (<?php echo $nfila ?>)</span>
						...
						if($i==1){
							...
							echo "<tbody>
									<tr>
										...
										<td class='td_cambiar_estado'><a class='link_cambiar_estado' title='Cambiar Estado' href='modificar_estado_inmueble.php?codigo_inmueble=".$dato['codigo_inmueble']."'>".$dato['estado_inmueble']."</a></td>										";
										?>
