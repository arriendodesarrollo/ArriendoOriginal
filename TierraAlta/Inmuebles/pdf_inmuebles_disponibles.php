<?php ob_start();
	...
	$conec=Conectarse();
	$sql = "SELECT * FROM alquiler_inmueble WHERE estado_inmueble='Disponible' ORDER BY codigo_inmueble ASC";
...
<body>
	...
	<center><h1>Inmuebles Disponibles (<?php echo $contador_inmuebles ?>)</h1></center>
	<table class="tabla_menu">
		...
		<?php
			...
			$fecha1 = date('d_m_Y');
			$hora1= date (" h_i a");
			$filename = "Informes/Inmuebles/InmueblesDisponibles_".$fecha1."__".$hora1.".pdf";
