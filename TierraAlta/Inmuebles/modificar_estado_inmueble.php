<?php session_start(); 
	...
	$cons=mysql_query("SELECT * FROM alquiler_inmueble WHERE estado_inmueble='Disponible' and codigo_inmueble='$codigo_inmueble'",$conec);
...
?>
	...
	<div class="contenedor_archivo">
		...
		<script>
	  	...
	  	<form method="post" name="form_asignar" class="FormModificar" action="GuardaContrato.php">
	  		<div class="TituloModalRegistro">Asignar inmueble</div>
			...
			<div class="cuadros_asignar quitar_borde">
				...
				<div class="DivInput">
					...
					<input type="number" onKeyUp="fncSumar()" name="meses_deposito" required placeholder="" />
				</div>
				...
				<div class="DivInput">
					...
					<div class="DivPrecio">
						<input type="number" onKeyUp="fncSumar()" name="gastos_administrativos" required />
						...
						<?php 
							...
							if (!$result_moneda1){
							   ...
							   exit();
								...
								?>
									<select name="moneda_gastos_administrativos" required>
					  					<option value="<?php echo $dato['moneda_precio_inmueble']; ?>"><?php echo $dato['moneda_precio_inmueble'] ?></option>
											<?php
												while ($row_moneda1 = mysql_fetch_row($result_moneda1)){
													if ($row_moneda1[1]==$dato['moneda_precio_inmueble']) {
														//no muestra nada
													} else {
									        			echo "
						...
						<?php 
							...
							if (!$result_moneda){
							   ...
							   exit();
								...
								?>
									<select name="moneda_gastos_legales" required>
					  					<option value="<?php echo $dato['moneda_precio_inmueble']; ?>"><?php echo $dato['moneda_precio_inmueble'] ?></option>
											<?php
			...
			<div class="caja_botones">
				...
				<a href="InmueblesDisponibles.php" class="btnBorrar">Atrás</a>
			</div>
